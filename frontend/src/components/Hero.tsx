...
// NBIM-style hero: full-bleed photo with a defining headline number overlaid,
// mirroring oljefondet's fund-value landing. The run action lives in the
// sticky bar below, so the hero stays a clean header.
    ...
    >
      <div className="hero-banner-inner">
        ...
        <div className="hero-banner-number">
          ...
          <span className="hero-banner-unit">entities across 18 jurisdictions</span>
        </div>
